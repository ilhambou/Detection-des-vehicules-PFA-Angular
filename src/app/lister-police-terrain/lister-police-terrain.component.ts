...
@Component({
  selector: 'app-lister-police-terrain',
  templateUrl: './lister-police-terrain.component.html',
  styleUrl: './lister-police-terrain.component.css'
})
export class ListerPoliceTerrainComponent {
  studentDetails =null;
